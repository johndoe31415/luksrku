...
parser.add_argument("--force-unlock-all", action = "store_true", help = "Force attempting of unlock of all volumes, regardless if they're already unlocked or not. Useful for testing unlocking procedure.")
